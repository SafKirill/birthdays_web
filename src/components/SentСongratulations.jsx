...
const SentСongratulations = () => {
  ...
  const handleCongratulationClick = async (id) => {
    try {
      ...
      const response = await fetch(
        `${apiUrl}/congratulation?congratulation_id=${id}`,
        requestOptions
      );
  ...
  useEffect(() => {
    const fetchCongratulations = async () => {
      try {
        ...
        const response = await fetch(
          apiUrl + "/all_congratulation_is_sender",
          requestOptions
        );
        if (response.ok) {
                ...
                <tbody className="employee-table-body">
                  {congratulations.map((congratulation) => (
                    ...
                    >
                      ...
                      <td>{congratulation.receiver_name}</td>
                      <td>
          ...
          {selectedCongratulation && (
            <div>
              ...
              <p>
                ...
                {selectedCongratulation.receiver_name}
              </p>
              <p>
...
export default SentСongratulations;
